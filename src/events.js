...
exports const on = (name, callback, context) => {
...
exports const listenTo = (obj, name, callback) => {
  if (!obj) return this;
...
export const off = (name, callback, context) => {
...
export const stopListening = (obj, name, callback) => {
...
export const once = (name, callback, context) => {
...
export const listenToOnce = (obj, name, callback) => {
  // Map the event into a `{event: once}` object.
...
export const trigger = (name, ...args) => {
  ...
  const argsL = Array(length);
  let i = 0;
  for (i = 0; i < length; i++) argsL[i] = args[i + 1];

  eventsApi(triggerApi, this._events, name, void 0, argsL);
  return this;
};
