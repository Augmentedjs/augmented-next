...
<head>
	...
	<meta name="viewport" content="width=device-width">
		<title>node_modules/next-core-security/src/authenticationFactory.js</title>
...
<body>
	...
	<!-- end:navbar.hbs -->		<div class="page-header">
			<div class="container">
				...
				<h1><span class="name">node_modules/next-core-security/src/authenticationFactory.js</span></h1>
			</div>
		</div>
	<div class="container content">
		...
		<section class="source-section">
			<article></article>
			<pre class="prettyprint source language-javascript line-numbers"><code class="language-javascript">import ClientType from "./clientType.js";
