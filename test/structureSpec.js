...
const makeUpNames = (data, map, amount) => {
...
describe('Given standard Data Structures', function() {
	...
	xdescribe('Given an array of objects', function() {
	let searchKey;
	beforeEach(() => {
		const map = new Augmented.Utility.Map();
		const indexHash = makeUpNames([], map, 100000);
		const key = "Name";
	...
	describe('Given an Array', function() {
		...
		it('can sort number array with QuickSort', function() {
			const sorted = Augmented.Utility.quickSort(arr);
		...
		it('can sort object array by property', function() {
			const sorted = Augmented.Utility.sortObjects(objArr, "name");
		...
		describe('can perform a binary search', function() {
			let sorted = Augmented.Utility.quickSort(arr), i, ii, comp = function(z, n) { return z - n; };
			afterEach(function() {
				i = null;
				ii = null;
			});
	...
	xdescribe('Given a Map', function() {
		var map;
	...
	xdescribe('Given Augmented Stack', function() {
		var s;
		beforeEach(function() {
